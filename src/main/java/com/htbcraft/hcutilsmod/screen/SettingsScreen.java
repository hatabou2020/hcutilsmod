...
//        guiGraphics.blit(RenderPipelines.GUI_TEXT, BACKGROUND_TEXTURE, x + 10, y + 10, 0, 0, width - 20, height - 20, 16, 16);
...
//
//        // ウィンドウ枠の4隅
//        guiGraphics.blit(RenderPipelines.GUI_TEXT, WINDOW_TEXTURE, x, y, 0, 0, 20, 30, 256, 256);
//        guiGraphics.blit(RenderPipelines.GUI_TEXT, WINDOW_TEXTURE, x + width - 20, y, 252 - 20, 0, 20, 30, 256, 256);
//        guiGraphics.blit(RenderPipelines.GUI_TEXT, WINDOW_TEXTURE, x, y + height - 20, 0, 140 - 20, 20, 20, 256, 256);
//        guiGraphics.blit(RenderPipelines.GUI_TEXT, WINDOW_TEXTURE, x + width - 20, y + height - 20, 252 - 20, 140 - 20, 20, 20, 256, 256);
//
...
//            texture_height = 30;
//
//            guiGraphics.blit(RenderPipelines.GUI_TEXT, WINDOW_TEXTURE, x1, y1, texture_x, texture_y, texture_width, texture_height, 256, 256);
//        }
//
//        // ウィンドウ枠の下線
//        for (int i = 0; i < count; i++) {
